angular.module('feature.reward')
  .controller('RewardCtrl', function($scope, $rootScope, $location, $state, $http, $stateParams, $mdDialog) {
    ...
    $scope.redeem = function(reward, currentlevel) {

      if (reward.inUse == 0 && currentlevel >= reward.level) {
      ...
      $mdDialog.show(confirm).then(function() {
        ...
        $http.get('https://pfhackathon.secanis.ch/api/updatereward/' + reward.rewardID)
